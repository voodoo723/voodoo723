...
select * --source, round(100 * avgWeighted(toFloat64(retention_rate), toFloat64(cohort_size))) as avgW_rr
from retention_by_cohorts
where days > 0 and days < 8 and source = 'organic' and start_dt between '2025-03-17' and '2025-03-23'
--group by source
